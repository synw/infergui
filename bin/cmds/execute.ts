...
let lmProcess: ChildProcessWithoutNullStreams | null = null;
let lmProm: Promise<string>;

async function runLm(command: string, args: Array<string>, {
  ...
  lmProm = new Promise((resolve, reject) => {
    ...
    lmProcess.on("error", (data: any) => onError(data));
